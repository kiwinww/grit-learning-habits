...
import { cancelPendingCompletion, completeTask, redeemReward, setTargetReward } from "@/lib/service";
...
export async function POST(request: Request) {
  try {
    ...
    else if (input.action === "cancelPendingCompletion") await cancelPendingCompletion(input);
